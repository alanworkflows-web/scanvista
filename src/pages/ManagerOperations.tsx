...
export function ManagerOperations() {
  ...
  return (
    <ManagerLayout>
      <div className="mb-6">
        <h1 className="text-2xl font-serif font-bold text-gray-900">Menu & Amenities</h1>
        <p className="text-gray-500 text-sm mt-1">Manage your property offerings and services.</p>
      </div>
      <OpsDashboardSheet propertySlug={property.slug} isReadOnly={isReadOnly} initialTab="menu" hiddenTabs={["qr"]} />
    </ManagerLayout>
  );
}
